...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTML",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4OTML45OTMLAddPushNotificationBlacklistActionCommand")
...
SWIFT_CLASS("_TtC4OTML33OTMLPushNotificationActionCommand")
...
SWIFT_CLASS("_TtC4OTML34OTMLPushNotificationBlacklistRules")
...
- (void)cleanBlacklist;
- (void)blackListAll;
- (void)removeRuleFromBlacklistWithIdWithId:(NSString * _Nonnull)id;
...
SWIFT_CLASS("_TtC4OTML48OTMLRemovePushNotificationBlacklistActionCommand")
...
SWIFT_CLASS("_TtC4OTML25OTMLSliderButtonComponent")
...
SWIFT_CLASS("_TtC4OTML24OTMPNetworkHmacSupporter")
@interface OTMPNetworkHmacSupporter : NSObject
+ (NSString * _Nonnull)elaborateBodyStringWith:(NSString * _Nonnull)bodyString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
