...
#ifndef OTMLCORE_SWIFT_H
#define OTMLCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTMLCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (SecKeyRef _Nullable)importPublicKeyReferenceFromDERCertificate:(NSData * _Nonnull)certData SWIFT_WARN_UNUSED_RESULT;
...
- (NSData * _Nullable)exportPublicKeyToDER:(NSData * _Nonnull)rawPublicKeyBytes keyType:(NSString * _Nonnull)keyType keySize:(NSInteger)keySize SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, copy) NSString * _Nonnull alpha3;
@property (nonatomic, copy) NSString * _Nonnull calling;
@property (nonatomic, copy) NSString * _Nonnull currency;
@property (nonatomic, copy) NSString * _Nonnull continent;
@property (nonatomic, copy) NSString * _Nonnull flag;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8OTMLCore10OTOSLogger")
@interface OTOSLogger : NSObject
+ (void)processLogData:(NSData * _Nonnull)data level:(NSInteger)level;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
